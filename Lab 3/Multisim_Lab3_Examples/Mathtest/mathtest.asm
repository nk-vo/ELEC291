...
wait_for_P2_0:
    setb P2.0
	jb P2.0, $ ; loop while the button is not pressed
	; No debounce needed with Multisim
	;Wait_Milli_Seconds(#50) ; debounce time
	;jb P2.0, wait_for_P2_0 ; it was a bounce, try again
	jnb P2.0, $ ; loop while the button is pressed
	ret
