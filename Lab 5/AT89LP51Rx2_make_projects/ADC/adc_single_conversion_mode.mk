...
OBJS=adc_single_conversion_mode.obj

adc_single_conversion_mode.hex: $(OBJS)
	$(CC) $(OBJS)
	@echo Done!
	
adc_single_conversion_mode.obj: adc_single_conversion_mode.c
	$(CC) -c adc_single_conversion_mode.c
...
LoadFlash:
	...
	..\Pro89lp\Pro89lp -p -v adc_single_conversion_mode.hex
...
Dummy: adc_single_conversion_mode.hex adc_single_conversion_mode.Map
